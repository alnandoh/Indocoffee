...
export default function About() {
  return (
    <section className="bg-one-800 text-three" id="about-us">
      <div className="wrapper py-12 md:py-16 lg:py-24 xl:py-28">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="order-1 lg:order-2 w-full aspect-video md:h-92 lg:h-full relative rounded-xl overflow-hidden">
            <Image
              src={Owner}
              alt="Owner Photo"
              layout="fill"
