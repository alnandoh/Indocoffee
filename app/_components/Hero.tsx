  ...
  return (
    <section className="relative min-h-[calc(100vh-60px)] flex items-center justify-center">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-8 bg-black bg-opacity-50">
        <div className="wrapper py-16 grid grid-cols-1 md:grid-cols-2 gap-4 text-stone-100 animate-fadeIn">
          <div className="flex flex-col justify-between gap-4">
            <h1 className="text-3xl md:text-6xl font-bold animate-slide-in-right">
              We are NusaBean Coffee
            </h1>
            <h2 className="text-2xl md:text-4xl animate-slide-in-right">
